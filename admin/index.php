                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
                      ...
                      <div class="card mb-2">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <?php 
                            $jmlkomen = mysqli_query($koneksi, "SELECT * FROM komentarfoto1 WHERE fotoid='$fotoid'");
                                ...
                                <div class="col-md-4">
                                    <div class="m-2">
                                        <div class="overflow-auto">
                                            ...
                                            <?php 
                                            $fotoid = $data['fotoid'];
                                            $komentar = mysqli_query($koneksi, "SELECT * FROM komentarfoto1 INNER JOIN user ON komentarfoto1.userid=user.userid WHERE komentarfoto1.fotoid='$fotoid'");
